...
public class se2_main_test {
	...
	public static void main(String[] args) {
		...
		SystemInterface systemInterface =  SystemInterface.getInstance(new DataManagement().loadData(fileAddress), new Scanner(System.in));
		...
		new DataManagement().writeData(systemInterface.fileOutputProcess(), fileAddress);
